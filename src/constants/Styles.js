...
export default StyleSheet.create({
  ...
  locationPopup: {
    ...
    justifyContent: 'flex-start',
    height: (Dimensions.get('window').height / 6) * 2.6,
    width: Dimensions.get('window').width,
    backgroundColor: pawGreen,
    borderTopLeftRadius: 35,
    borderTopRightRadius: 35,
  ...
  locationImage: {
    ...
    width: 125,
    borderRadius: 100,
    left: Dimensions.get('window').width / 2 - 65.5,
    top: -62.5,
    borderWidth: 3,
    margin: 0,
    justifyContent: 'center',
  ...
  navButton: {
    ...
    width: 180,
    borderRadius: 100,
    left: (Dimensions.get('window').width / 2) * 0.94,
    bottom: 20,
    position: 'absolute',
  },
  newLocSubmit: {
  ...
  eventBottomBorder: {
    borderBottomColor: pawPink, // pawgreen in dark
    borderBottomWidth: 3,
    borderRadius: 50,
    marginBottom: 15,
  },
  ...
  pawPicsWrappingView: {
    borderColor: pawWhite, // pawgreen,
    backgroundColor: pawWhite, // pawgreen,
    borderRadius: 50,
    width: 6,
  ...
  insPicLine: {
    borderBottomColor: pawPink, // pawgreen
    borderBottomWidth: 1,
    borderRadius: 50,
  ...
  postLine: {
    borderBottomColor: pawPink, // green
    borderBottomWidth: 1,
    borderRadius: 50,
    marginBottom: 5,
    marginLeft: 10,
  ...
  profilePhotoCardScroll: {
    width: Dimensions.get('window').width,
    left: -12,
    marginBottom: Platform.OS === 'android' ? 400 : 415,
  },
  profileCardView: {
    borderColor: pawWhite, // green
    backgroundColor: pawWhite, // green
    borderRadius: 50,
    width: 6,
    height: Platform.OS === 'android' ? (Dimensions.get('window').width - 90) : (Dimensions.get('window').width - 125),
    marginTop: Dimensions.get('window').width,
  ...
  textBoxNew: {
    ...
    justifyContent: 'center',
    height: 400,
    backgroundColor: pawWhite, // pawlightGrey
    left: 3.5,
  },
  tagsBox: {
    padding: 0,
