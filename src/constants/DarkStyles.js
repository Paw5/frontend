...
export default StyleSheet.create({
  ...
  datePicker: {
    ...
    textDefaultColor: pawGreen,
    selectedTextColor: pawLightGrey,
    mainColor: pawYellow,
    textSecondaryColor: pawYellow,
    borderColor: pawLightGrey,
  ...
  newlocationPopup: {
    ...
    alignSelf: 'center',
    justifyContent: 'flex-start',
    height: (Dimensions.get('window').height / 6) * 1.8,
    width: Dimensions.get('window').width - 20,
    backgroundColor: pawGrey,
    borderTopLeftRadius: 35,
    borderTopRightRadius: 35,
